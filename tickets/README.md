...
| 16 | [Partner Research Pack v1](ticket-16-research-pack-v1.md) | 2 | 15 (zacht) | Taak 0 t/m 3 plus 4.1/4.2/4.3 van `Onboarding workflow/Stappenplan-Research-Workflow-n8n.md` gedaan (2026-07-15): hoofd-workflow "Fundament" (`I6wPX5cUZcKjiugp`, inactief) met sheet-gebaseerde invoer, tagscan, Semrush-, reviews- (Google Maps + Trustpilot + echte Gemini-thema-extractie) en ad-libraries-branch (Meta + Google, actors gekozen via Apify's store-API); tagscan-sub-workflow (`LkH0bLVZVCaYInop`) uit taak 2. Meerdere echte fouten gevonden en gecorrigeerd tijdens testen (zie LOG.md). HubSpot-tak (3.2), TikTok-actor (4.2) en stap 4.4/4.5/4.6 bewust uitgesteld (gelogd, niet vergeten). Volgende sessie: taak 5 (AI Agent-blokken) heeft nu prioriteit, daarna de resterende taak-4-branches. Semrush- en Apify-credential-koppeling wacht op verificatie door Hidde (zie hidde-actielijst.md) |
