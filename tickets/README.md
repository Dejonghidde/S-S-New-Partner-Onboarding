...
| 16 | [Partner Research Pack v1](ticket-16-research-pack-v1.md) | 2 | 15 (zacht) | Taak 0 t/m 6 (volledig, inclusief 6.4) van `Onboarding workflow/Stappenplan-Research-Workflow-n8n.md` gedaan (2026-07-16): hoofd-workflow "Fundament" (`I6wPX5cUZcKjiugp`, inactief, 77 nodes) van sheet-invoer tot een echt Google Doc plus prefill-JSON in de test-Drive-map: tagscan, Semrush-, reviews-, ad-libraries-, LinkedIn-, Instagram/socials-, screenshots-branch, zeven AI Agent-blokken en de assemblage (kostenregel met echte Apify-tarieven, documenttekst, Doc-aanmaak via één Google Drive-node, prefill-naar-bestand). Stap 6.4 (echte end-to-end-run, execution 97299) bevestigd: echt Google Doc en prefill-JSON in de Shared Drive-testmap, na het oplossen van een bekende n8n-bug (Google Docs-node ondersteunt geen Shared Drives) en twee bugfixes (verkeerde bestands-URL door een Merge-veldnaamconflict, "undefined" in de prefill-bestandsnaam); volledige toedracht in LOG.md. Ook onderzocht: hoe de vragenlijst een prefill-JSON aan de juiste partner koppelt (Drive-map-id als bestaande, al-ontworpen sleutel via de registry-tab en het `?c=`-token; nog niet bedraad, hoort bij ticket 17). Bewust uitgesteld: HubSpot-tak, visuele rubric (stub), Google Search grounding, TikTok/YouTube/X/LinkedIn-profielstatistieken binnen socials, laag-3-fallback screenshots, Instagram-actor 12 i.p.v. 25 posts, opmaak van de documenttekst (platte tekst, geen rich text), cross-check-bevindingen nog niet automatisch verwerkt in het document. Volgende sessie: taak 7 (proefbedrijven: Uitelkaar.nl, Boekenwereld, WONDR Experience) |
