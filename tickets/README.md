...
| 16 | [Partner Research Pack v1](ticket-16-research-pack-v1.md) | 2 | 15 (zacht) | Taak 0 t/m 5 van `Onboarding workflow/Stappenplan-Research-Workflow-n8n.md` gedaan (2026-07-15): hoofd-workflow "Fundament" (`I6wPX5cUZcKjiugp`, inactief, 51 nodes) van sheet-invoer tot pack-concept en prefill-JSON: tagscan, Semrush-, reviews-, ad-libraries-branch en de vijf AI Agent-blokken (profiel/markt/funnel/aannames-synthese/cross-check). Volledige end-to-end testrun met vijf echte, live LLM-aanroepen geeft kwalitatief goede output (zie LOG.md). Meerdere echte fouten gevonden en gecorrigeerd tijdens testen. Bewust uitgesteld (gelogd, niet vergeten): HubSpot-tak (3.2), taak 4.4/4.5/4.6 (LinkedIn/socials/screenshots), visuele rubric (stub i.p.v. echte call, geen screenshots), Google Search grounding (beslispunt op actielijst). Volgende sessie: taak 6 (assemblage naar Google Doc + prefill-bestand) of alsnog de resterende taak-4-branches. Semrush- en Apify-credential-koppeling: Hidde bevestigt Semrush en Apify aangemaakt/goed |
