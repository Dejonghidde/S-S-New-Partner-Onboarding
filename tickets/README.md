...
| 16 | [Partner Research Pack v1](ticket-16-research-pack-v1.md) | 2 | 15 (zacht) | Taak 0 t/m 6 (6.1-6.3) van `Onboarding workflow/Stappenplan-Research-Workflow-n8n.md` gedaan (2026-07-16): hoofd-workflow "Fundament" (`I6wPX5cUZcKjiugp`, inactief, 78 nodes) van sheet-invoer tot een echt Google Doc plus prefill-JSON in de test-Drive-map: tagscan, Semrush-, reviews-, ad-libraries-, LinkedIn-, Instagram/socials-, screenshots-branch, vijf AI Agent-blokken en de assemblage (kostenregel met echte Apify-tarieven, documenttekst, Docs-create/update, prefill-naar-bestand). Volledige structurele testruns kwalitatief goed (zie LOG.md); tijdens testen een echte, latente taak-5-bug gevonden en gefixt (cross-check-bevindingen kwamen leeg binnen door verkeerde node-referentie). **Geblokkeerd (stap 6.4):** de Google Docs-credential heeft geen toegang tot de test-Drive-map (404 bij een echte run); wacht op Hidde om de map te delen of een andere credential aan te wijzen, zie actielijst. Bewust uitgesteld: HubSpot-tak, visuele rubric (stub), Google Search grounding, TikTok/YouTube/X/LinkedIn-profielstatistieken binnen socials, laag-3-fallback screenshots, Instagram-actor 12 i.p.v. 25 posts, opmaak van de documenttekst (platte tekst, geen rich text), cross-check-bevindingen nog niet automatisch verwerkt in het document. Volgende sessie: stap 6.4 zodra de Drive-toegang is opgelost, dan taak 7 (proefbedrijven: Uitelkaar.nl, Boekenwereld, WONDR Experience) |
