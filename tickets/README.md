...
| 16 | [Partner Research Pack v1](ticket-16-research-pack-v1.md) | 2 | 15 (zacht) | Taak 0 t/m 2 van `Onboarding workflow/Stappenplan-Research-Workflow-n8n.md` gedaan (2026-07-15): toegangscheck, referentiebestanden, en de tagscan-sub-workflow (`LkH0bLVZVCaYInop`, inactief) gebouwd en getest op 5 sites; 2 echte fouten gevonden en gecorrigeerd tijdens het testen (zie LOG.md). Credentials/test-Drive-map zijn door Hidde bevestigd. Volgende sessie: taak 3 (hoofd-workflow "Fundament") |
