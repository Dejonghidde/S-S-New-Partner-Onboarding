...
| 15 | [Vragenlijst-sanering -50%](ticket-15-vragenlijst-sanering.md) | 2 | Bart-tabel (bindend), deploy met go | Hoe-uitwerking klaar (2026-07-15, `Onboarding workflow/Uitwerking-Fase-2-Vragenlijst-en-Research-Pack.md`); uitvoering nog te starten |
| 16 | [Partner Research Pack v1](ticket-16-research-pack-v1.md) | 2 | 15 (zacht) | Hoe-uitwerking klaar (2026-07-15, zelfde document); Sharif-antwoord binnen: geen bestaande flow, aanbeveling Claude-run als v1-agent |
| 17 | [Research Pack v2: automatisch (GATED)](ticket-17-research-pack-automatisering.md) | 2 | 16: drie bewezen packs + go Hidde | Gated; architectuurrichting vastgelegd in de hoe-uitwerking (2026-07-15) |
