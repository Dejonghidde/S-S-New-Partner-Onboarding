...
| 16 | [Partner Research Pack v1](ticket-16-research-pack-v1.md) | 2 | 15 (zacht) | Taak 0 en 1 van `Onboarding workflow/Stappenplan-Research-Workflow-n8n.md` gedaan (2026-07-15): toegangscheck plus zes referentiebestanden in `Onboarding workflow/research-workflow/`. Credentials (Semrush, Gemini, dedicated OpenAI/Apify) en de test-Drive-map wachten op Hidde, zie `hidde-actielijst.md`. Volgende sessie: taak 2 (tagscan sub-workflow in n8n) |
