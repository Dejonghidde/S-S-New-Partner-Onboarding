...
| 16 | [Partner Research Pack v1](ticket-16-research-pack-v1.md) | 2 | 15 (zacht) | Taak 0 t/m 3 van `Onboarding workflow/Stappenplan-Research-Workflow-n8n.md` gedaan (2026-07-15): toegangscheck, referentiebestanden, tagscan-sub-workflow (`LkH0bLVZVCaYInop`) en hoofd-workflow "Fundament" (`I6wPX5cUZcKjiugp`, inactief) gebouwd en getest; 3 echte fouten gevonden en gecorrigeerd tijdens het testen (zie LOG.md). Op instructie Hidde: trigger omgezet naar sheet-gebaseerde invoer (i.p.v. form), HubSpot-tak (3.2) bewust overgeslagen, prioriteit nu naar taak 4 en 5. Semrush-credential wacht op Hidde (zie hidde-actielijst.md) |
