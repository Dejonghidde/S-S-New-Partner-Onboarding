...
| 16 | [Partner Research Pack v1](ticket-16-research-pack-v1.md) | 2 | 15 (zacht) | Taak 0 t/m 5 plus 4.4/4.5/4.6 van `Onboarding workflow/Stappenplan-Research-Workflow-n8n.md` gedaan (2026-07-15): hoofd-workflow "Fundament" (`I6wPX5cUZcKjiugp`, inactief, 69 nodes) van sheet-invoer tot pack-concept en prefill-JSON: tagscan, Semrush-, reviews-, ad-libraries-, LinkedIn-, Instagram/socials- en screenshots-branch plus de vijf AI Agent-blokken (profiel/markt/funnel/aannames-synthese/cross-check). Volledige end-to-end testruns met echte, live LLM-aanroepen geven kwalitatief goede output (zie LOG.md). Meerdere echte fouten gevonden en gecorrigeerd tijdens testen. Bewust uitgesteld (gelogd, niet vergeten): HubSpot-tak (3.2), visuele rubric (stub i.p.v. echte vision-call), Google Search grounding (beslispunt op actielijst), TikTok/YouTube/X/LinkedIn-profielstatistieken binnen socials, laag-3-fallback voor screenshots (kandidaat: Firecrawl), Instagram-actor levert 12 i.p.v. 25 posts. Volgende sessie: taak 6 (assemblage naar Google Doc + prefill-bestand), dan taak 7 (proefbedrijven: Uitelkaar.nl, Boekenwereld, WONDR Experience). Nieuwe Apify/Drive-credentials op de nog-te-koppelen-lijst in de actielijst |
